...
Wallet Service - это приложение, предоставляющее функциональность для управления финансовыми операциями клиентов. Реализованы Rest-контроллеры(Spring MVC), Swagger + Swagger UI.
Для маппинга сущностей в дто используется MapStruct.
Реализация аспектов на Spring AOP.
